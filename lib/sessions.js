...
const { readArray, writeArray } = require("./json-file-store");
...
// Used by account deletion — the account may be logged in on other
// devices/browsers, not just the one that requested the deletion.
